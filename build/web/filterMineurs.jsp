...
<%
    ...
    try {
        ...
        // Créer la requête SQL pour sélectionner les étudiants mineurs
        String query = "SELECT * FROM etudiant WHERE DATEDIFF(CURDATE(), datenais) < 6570"; // 6570 jours = 18 ans

        // Exécuter la requête
        stmt = con.createStatement();
        rs = stmt.executeQuery(query);

        // Générer le HTML pour la table des étudiants mineurs
        while (rs.next()) {
%>
            <tr>
